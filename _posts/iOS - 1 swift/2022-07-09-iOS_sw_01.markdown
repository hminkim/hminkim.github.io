...
<center><table>
    ...
    <tr>
        ...
        <td colspan="2"><div style="text-align:center"><b>가르키는 인스턴스의 RC의 숫자를 올라가지 않게 함</b> (인스턴스 사이의 강한 참조를 제거)<br><font size="2em">weak/unowned로 선언한 변수를 통해 인스턴스에 접근은 가능하지만, 인스턴스를 유지시키는 것은 불가능</font></div></td>
    </tr>
    <tr>
