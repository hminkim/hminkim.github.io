...
|:---:|:---:|:---:|
|실제 물리적인 계산을 실행|물리적인 Threaddhk 1대1 매칭이 아님<br>NSThread 객체의 모음|대기열 Queue를 통한 작업 분배|
...
<center><table>
  ...
  <tr>
    <td rowspan="3"><div style="text-align:center">Dispatch<br>Queue<br>(GCD)<br><font size="1em">(Class)</font></div></th>
